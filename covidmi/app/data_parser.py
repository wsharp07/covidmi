class DataParser:
  ...
  def is_valid(self, county):
    if (county == 'Other*'): return False
    if (county == 'Out of State'): return False
    if (county == 'Unknown'): return False
    if (county == 'Total'): return False
    if (county == 'County'): return False
