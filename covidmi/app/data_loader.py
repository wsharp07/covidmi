...
class DataLoader:
  def __init__(self, parser):
    self.parser = parser
    self.url = 'https://www.michigan.gov/coronavirus/0,9753,7-406-98163-520743--,00.html'
  ...
  def load_data(self):
    ...
    for row in table_rows:
      ...
      if (self.parser.is_valid(county) == False): continue

      self.data.append({'county': county, 'cases': cases, 'deaths':deaths})
